...
<div class="middle_container" id="myTabContent">
    <div class="tab-pane fade show active wrap_content_mid" id="one" role="tabpanel" aria-labelledby="one-tab">
        <div class="head-mid">
            <h2>Create a Job Offer (Duplicate)  <?//=$_SESSION['Country'];?><b style="color: #ff0000;"></b></h2>
        </div>
        <form action="admin/inc/process.php?action=CreateJob" method="post" class="service-form example" enctype="multipart/form-data">
            ...
            <textarea class="form-control static-textarea" name="topic" rows="4" placeholder="Write something here..." id="textbox" onkeyup="charcount(this.value)" maxlength="70" required><?=$editjob['topic'];?></textarea>
      <input type=hidden name="postid" value="<?=$editjob['id'];?>">
            ...
            <div class="row flex-row">
                <div class="col-lg-6 col-6 wrapper_state">
                    <label>State:</label>
                    <input type="text" placeholder="State" name="state" value="<?=$editjob['State'];?>">
                </div>
                <div class="col-lg-6 col-6 wrapper_city">
                    <label>City:</label>
                    <input type="text" placeholder="City" name="city" value="<?=$editjob['City'];?>">
                </div>
