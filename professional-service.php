...
<!--invite for job interview button start here and whole content ends in the footer-->
                             <div>
                                <button class="invt-job-intrvw" data-toggle="modal" type="button" data-target="#exampleModalCenter"  value="<?=$postuser['id'];?>">Invite for job interview</button>
                            </div>
                            


<!----------------------pop up for  invite jopb post ------------------------------>
<!-- Button trigger modal -->
<!--Invite to your job post button start here and whole content ends in the footer-->
 <div>
    <button type="button" data-toggle="modal" data-target="#exampleModal" class="invite-jop-post">Invite to your job post</button>
</div>
